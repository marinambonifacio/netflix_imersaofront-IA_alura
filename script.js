...
profileCards.forEach((card) => {
    card.addEventListener('click', () => {
        const profileName = card.dataset.profileName || card.querySelector('figcaption')?.textContent;
        const profileImage = card.dataset.profileImage || card.querySelector('img')?.src;
